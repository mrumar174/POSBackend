        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubscriptionPlanCode = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SubscriptionStartDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    SubscriptionEndDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    MaxShops = table.Column<int>(type: "int", nullable: false),
                    MaxUsers = table.Column<int>(type: "int", nullable: false),
                    DataIsolationMode = table.Column<int>(type: "int", nullable: false),
                    IsolatedConnectionString = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AddedBy = table.Column<int>(type: "int", nullable: true),
                    AddedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedBy = table.Column<int>(type: "int", nullable: true),
                    UpdatedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ExpenseNo = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DifferenceQuantity = table.Column<decimal>(type: "decimal(18,3)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReferenceId = table.Column<int>(type: "int", nullable: true),
                    ReferenceNo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    QuantityIn = table.Column<decimal>(type: "decimal(18,3)", nullable: false),
                    QuantityOut = table.Column<decimal>(type: "decimal(18,3)", nullable: false),
                    UnitCost = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Remarks = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AddedBy = table.Column<int>(type: "int", nullable: true),
                    AddedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CashTransactions_ShopId_TransactionNo",
                table: "CashTransactions",
                columns: new[] { "ShopId", "TransactionNo" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DailyCashClosings_ShopId_ClosingDate",
                table: "DailyCashClosings",
                columns: new[] { "ShopId", "ClosingDate" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Expenses_ShopId_ExpenseNo",
                table: "Expenses",
                columns: new[] { "ShopId", "ExpenseNo" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseReturns_ShopId_ReturnNo",
                table: "PurchaseReturns",
                columns: new[] { "ShopId", "ReturnNo" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Purchases_ShopId_InvoiceNo",
                table: "Purchases",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SaleReturns_ShopId_ReturnNo",
                table: "SaleReturns",
                columns: new[] { "ShopId", "ReturnNo" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sales_ShopId_InvoiceNo",
                table: "Sales",
                columns: new[] { "ShopId", "InvoiceNo" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Shops_TenantId_Code",
                table: "Shops",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockAdjustments_ShopId_AdjustmentNo",
                table: "StockAdjustments",
                columns: new[] { "ShopId", "AdjustmentNo" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SupplierPayments_ShopId_PaymentNo",
                table: "SupplierPayments",
                columns: new[] { "ShopId", "PaymentNo" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Units_TenantId_ShortName",
                table: "Units",
